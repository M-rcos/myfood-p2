...
public class Facade {
    ...
    public String getEntregadores(String empresa) {
        return entregadorManager.getEntregadores(empresa);
    }

    public String getEmpresas(String entregador) {
        return entregadorManager.getEmpresas(entregador);
    }
    ...
    public String obterPedido(String entregador) {
    ...
    public String getIdEntrega(String pedido) {
        return entregaManager.getIdEntrega(pedido);
    }

    public void entregar(String entrega) {
